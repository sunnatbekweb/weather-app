...
const WeatherInfo: React.FC = () => {
  ...
  const getWeatherIcon = (weatherDescription: string): JSX.Element => {
    ...
    const iconMapping: Record<
      string,
      { icon: JSX.Element; style: React.CSSProperties }
    > = {
      clear: {
        icon: <WbSunny />,
        style: { color: "yellow" },
            ...
            <div className="aqi">
              ...
              <div className="text">
                ...
                <span>
                  {weatherData.aqi < 50
                    ? "Good"
                    : "" || (weatherData.aqi > 51 && weatherData.aqi < 100)
                    ? "Moderate"
                    : "" || (weatherData.aqi > 101 && weatherData.aqi < 150)
                    ? "Unhealthy for Sentensive Groups"
                    : "" || (weatherData.aqi > 151 && weatherData.aqi < 200)
                    ? "Unhealthy"
                    : "" || (weatherData.aqi > 201 && weatherData.aqi < 300)
                    ? "Very Unhealthy"
                    : "" || weatherData.aqi > 300
                    ? ""
                    : "Hazardous"}
